...
<div class="rounded-lg {{ $is_joined? 'bg-primary' : 'bg-base-200' }} px-3 py-1 flex gap-2 items-center">
    <div id="copy-{{ $code }}" class="tooltip-left md:tooltip-right"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="w-4 cursor-pointer hover:text-base-content" onclick="copyToClipboard('kanban-{{ $code }}', 'copy-{{ $code }}'); event.stopPropagation(); return false;">
